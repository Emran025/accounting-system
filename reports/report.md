...
يجدر الذكر بأن وحدة الموارد البشرية قيد الانتهاء ويجب المرور بهذه المراحل حتى تكون تم الإنتهاء منها 100% :

المرحلة 1 :
 تنبقي بعض فورمات الadd والتحقق من توافقها مع ال endpoints الخاصة بها وكذلك التحقق من ال parameters الخاصة بها بأنها موحدة مع الواجهة ولا يوجد أي خلل بها ...

بعد عمل ال forms الخاصة بالadds يجب أن نتحقق من المكونات القابلة للإستخدام التي كان من المفترض نستخدمها على سبيل المثال ال labels التي على الصفحات 

بعد عملية الإنتهاء من المكونات الحالية تماما يجب التحقق من أسلوب ال filters التي يتم العرض بها يجب أن تكون صفا واحدا وأن تكون احترافية ...

المرحلة 2 :

إضافة مكون على الصفحة يكون مختصا بالتقارير الورقية والوثائق ولكل نوع وثائق يجب أن تكون هنالك templates أولية لعملية الكتابة والتعديل عليها ويحدد أين يتم التعديل عليها كذلك منتج البطائق وكذلك وثائق اخلاء العهد وكذلك أي وثائق مهمة يتم طباعتها من هنالك 

يتم التعدي على مكون أصول الموظف بحيث لا تكون أصول يتم ادخالها من البداية إنما يتم إدخال عملية ربط بالأصل الذي على النظام حيث يكون الأصل مضاف مسبقا ومحدد مكان تواجده وهذه فقط عملية استلام وبجب أن لا يكون هنالك موظف مرتبط بهذا الأصل فإما أن يكون جديدا أو مضاف استلامه مؤخرا من موظف تم تسريحه أو قدم استقالته أو تم ترقيته وتسليم العهد منه 

عند إجراء انهاء خدمة في منصب يتم تسليم العهد ويمكن طبعاة تقرير أو الإطلاع عليه بالعهد الحالية ويمكن إعادة تقييم حالتها قبل أن تتحول إى أصول بدون مستلم 
بعض المكونات تستخدم بيانات متكرر كالإيميل والإسم وربما هذا ينعكس حتى على الخلفية في الترحيلات ويجب تعديله لتعمل كل المكونات كشيء لا يوجد فيه تكرارات بيانات 

يجب أن تتوفر التقارير بأداء رفيع المستوى ويمكن الإطلاع عليها بحالة الشاشة أو طباعتها بكل سلاسة في جميع الوحدات بدون استثناء لكي يكون متقدما واحترافيا 

يجب التحقق من أنه يتم رفع الملفات الخاصة بالسير الذاتية على شكل ملفات والمستدات الداعمة ويجب بناء مكونات الوجهة والخلفية لترتيب الملفات هذه

يجب عمل تحكم من الواجهة لعملية إدخال بيانات الجهازات البصمة بطريقة تحكمية من الواجهة لتكون مختصة بعملية الحضور والإنصراف وليس إدخال يدوي لعملية الحضور والإنصراف 


يجب عمل مكون داخل الموارد البشرية يختص بربط الموظفين بالمستخدمين حيث هنا في هذه المرحلة يجب إضافة 1- المكون الذي على الإعدادت `C:\xampp\htdocs\accsystem\public\app\system\settings\components\RolesTab.tsx` بل يجب نقله إلى هذا الموقع مباشرة كما هو مع نقل الارتباطات وبعد تحديد هنا من تكوين المسمى الوظيفي يجب دمجه مع امجانية تحديد الطاقة الاستياعبية لهذا المنصب أو المسمى الوظيفي وربطه مع القسم الخاص به ويمكن زيادته أو تعديله حسب الحاجة وحسب السياسة التي عليها المؤسسة يتم الرجوع إلى نوع الإختيار في نوع السياسة أو الإعداد التهيئة يتم رؤية هل توزيع الصلاحيات يتمتعيينها على مستوى المسمى الوظيفي أم على مستوى القسم لكل مسمى وظيفي أو على مستوى الفرد (لكل فرد صلاحيات مستقلة يمكن زيادتها أو تقليلها حسب الحاجة والسياسة ) إذا كان هنالك حسب مستوى الفرد يمكن تحديد هل هي متدرجة أو يمكن التحكم بها حسب السلم الوظيفي الأعلى منه فالأعلى أم يمكن أن تحدد فقط على مستوى إداري رفيع ... إذا كانت متفاوتة حسب كل موظف هل يتم اعتماد قوال (يجب أن يكون هنالك قوالب في النظام مثل موظف موثوق وموظف قيد التجربة وو وتحدد هذه مجموعة صلاحيات لكل مسمى وظيفي على حدة ) إذا تم اختيارها يمكن التعديل على أي قالب من تقليس أو توسيع الصلاحيات أو الرتب في القوالب من زيادتها أو تقليلها وهذه مرحلة من الاعداد في هذه المكون أم الإعداد الثاني فيتعلق باختيار الموظف لنفس المسمى الوظيفي في منصب معين على قسم معين وتعدين هل له مستخدم أم لا إذا كان لديه مستخدم يتم الرجوع الى نوع السياسة المختارة هل توزع الصلاحية له حسب المسى الوظيفي أم هل يجب أن تكون مرنة ليتم التحكم بالصلاحيات على مستوى الفرد ولو كانت على مستوى الفرد (صلاحيات متفاتة بين الموظفين لكل موظف صلاحيات مع وجود تجميعات مثلاموظف تحت التجربة أو موثوق أو غيره يكون في قوالب لكل موظف وكل مسمى وظيفي وتظام بشكل أساسي إلى ال seeder )

المرحلة 3 :

في هذه المرحلة يجب أن نظيف مكون مخفي يمكن الوصول اليه بدون الوصول اليه من تجربة المستخدم الحالية حيث سيكون مستقبلا هو عملية تهيئة النظام حيث يجب المرور على كافة الوحدات والنظر في المدخات يجب أن نقوم بعملية منطقية من التحقق من المخلات لكل وحدة ورؤسة ما إذا كانت منطقية ومتوافقة مع نظم ال ERP ومن ثم عمل نقل التحكم بالمدخلات التي يمكن أن يتم أتمتتها على وحدة التهيئة (config) وهنا سيتم اختيار على سبيل أبسط مثال (مثلا من كم يتكون رقم الموظف في المؤسسة وهل يجب تظمين رقم القسم أو الفرع في مقدمة الرقم ... يتم إدخال تفاصيل بعض الأقسام الوظيفية والهيكل الوظيفي وتهيئتها حسب شجرة ... يتم اختيار في التهيئة أنواع الإجازات ويمكن اختصارها عبر اختصار رقم الدولة لإدخال الإجازات الحكومية مثلا وغيرها -حيث سيتم إضافة بيانات كافة الدول العربية والشرق أوسطية من إجازات على ال seeder - كذلك بالنسبة لبقية الإجازات ونوعها وتعميمها على الأقسام أو انواع المسمى الوظيفي ... يتم ادخال المناصب الوظيفية والطاقة الإستياعبية لكل مسمى وظيفي على سبيل المثال مبيعات موظفين كاشير واحد على النقطة 1 والثاني على النقطة 2 وبهذا نخلق عملة أتمتة لموقع وظيفي واخلاؤه وجلعه شاغرا وملؤه ... في عملية الإعدادا هذه ستجعل فورمات الإدخال متينة ومتماسكة بعد الإعداد وأثناء العمل فمثلا يمكن إختيار طريقة المؤسسة في صرف الرواتب أو الفترات الزمنية وكذلك طريقة صرف الرواتب (بنك ، من الصندوق المؤسسي ... إلخ) كذلك شركات التأمين المرتبطة وهل يوجد تأمين في الأصل ... كذلك أنواع المستحقات في المؤسسة والمكافآت وهل يوجد مصروفات طيران ووو إلخ أم لا ... في مرحلة الإعداد سيتم اختيار ما إذا كان عملية احتساب الراتب يأتي بعد احتساب الحضور والإنصراف وكذلك تحديد هل يتم احتساب الإجازات ... يجب تحديد في هذه المرحلة كيف سيكون سلوك النظام في احتساب الإجازات فمثلا عندما يطلب الموظف إجازة أسبوع هل سيتم احتساب الإجازة الإسبوعية من ضمن هذه الفترة أم لا وكيف سيتعامل النظام معها يجب أن تكون مؤتمتة وتحدد مسبقا حسب سياسة المؤسسة ) 

مرحلة الإعداد هذه مهمة ويجب تخزينها على جداول وجعله تحدد طريقة التعامل مع وحدة الموارد البشرية وسلوك الوحدة ككل وما هو موجود وما هو غير موجود من الوحدات حسب سياسة المؤسسة ونطاقها يجب أن تكون متينة وموحدة وتعمل بسلاسة ويسر 
يجب تحديد في هذه المرحلة أنواع القوالب المختارة وكذلك ما الذي يمكن تصديره أو استيراده من التقارير أو الجداول أو الكشوفات وكذلك الأعمدة تحدد مع كل تقرير حسب الحاجة 
يجب توفير امكانية استيراد وتصدير هذه الاعدادات التي تم تهيئته عليها بكل يسر 
يجب توفير إمكانية توفير تعديل على أي سياسة والتعامل معها حيب المفترة التي كانت تلك السياسة عليها لكل فترة حتى في التقارير المالية 
يجب عمل في كل مختارات عملية recomanded منها حيث يتم تحديد الموصى بها ولتكون هذه الإفتراضية لبعض السياسات الغير أساسية في المؤسسة ...


يجب توفير امكانية تصدير أو استيراد أي تقرير أو كشف من جدول وكذلك تحديد ما الذي يمكن منها وما الذي لا يمكن يمكن تحديده من الإعدادات التهيئة 

المرحلة 4 : 

بناء الإختبارات التكاملة والتحقق منها والإصلاح عندما يتطلب الأمر ...


تنفيذ كافة هذه المراحل يجب أن تكون كل مرحلة يتم إنجازها في يوم واحد فقط 