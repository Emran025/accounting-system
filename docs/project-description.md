...
## Project Idea
The Supermarket Management System is designed as a lightweight yet powerful ERP solution for small to medium-sized retail businesses. It focuses on the core pillars of retail: Product Cataloging, Inventory Control, Purchasing (Inbound), and Sales (Outbound).
...
- **Currency**: All amounts are assumed to be in the local currency (handled as DECIMAL in DB).
